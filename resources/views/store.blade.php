                            ...
                            <div class="card-body">
                                ...
                                <div class="row g-3 align-items-center">
                                    <div class="col-md-12">
                                        ...
                                        <input value="{{ $store ? $store->name : '' }}" required type="text"
                                            class="form-control" name="name" placeholder="Store Name">
                                    </div>
                                    <div class="col-md-12">
                                        <label class="form-label">Address</label>
                                        <input value="{{ $store ? $store->address : '' }}" required type="text"
                                            class="form-control" name="address" placeholder="Address">
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label">State</label>
                                        <input value="{{ $store ? $store->state : '' }}" required type="text"
                                            class="form-control" name="state" placeholder="State">
                                    </div>

                                    <div class="col-md-6">
                                        <label class="form-label">Country</label>
                                        <input value="{{ $store ? $store->country : '' }}" required type="text"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input value="{{ $store ? $store->email : '' }}" required type="email"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input value="{{ $store ? $store->phone : '' }}" required type="number"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input value="{{ $store ? $store->geocode_latitude : '' }}" type="text"
                                            class="form-control" name="geocode_latitude" placeholder="Latitude">
                                    </div>

                                    <div class="col-md-6">
                                        <label class="form-label">Location Longitude (For Contact Page Google Map)</label>
                                        <input value="{{ $store ? $store->geocode_longitude : '' }}" type="text"
                                            class="form-control" name="geocode_longitude" placeholder="Longitude">
                                    </div>
                                ...
                                <div class="card-body">
                                    <div class="row g-3 align-items-center">
                                        <div class="col-md-12">
                                            ...
                                            <input value="{{ $store ? $store->meta_title : '' }}" type="text"
                                ...
                                <div class="card-body">
                                    <div class="row g-3 align-items-center">
                                        <div class="col-md-12">
                                            ...
                                            <input value="{{ $store ? $store->facebook_link : '' }}" type="text"
                                                class="form-control" name="facebook_link" placeholder="Facebook Link">
                                        </div>
                                        <div class="col-md-12">
                                            <label class="form-label">Instagram Link</label>
                                            <input value="{{ $store ? $store->instagram_link : '' }}" type="text"
                                                class="form-control" name="instagram_link" placeholder="Instagram Link">
                                        </div>
                                        <div class="col-md-12">
                                            <label class="form-label">Twitter Link</label>
                                            <input value="{{ $store ? $store->twitter_link : '' }}" type="text"
                                                class="form-control" name="twitter_link" placeholder="Twitter Link">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="row g-3 align-items-center">
                                        <div class="col-md-12">
                                            ...
                                            <input value="{{ $store ? $store->payment_pub_key : '' }}" type="text"
                                                class="form-control secret" name="payment_pub_key"
                                                placeholder="Publishable Key">
                                        </div>
                                        <div class="col-md-12">
                                            <label class="form-label">Secret Key</label>
                                            <input value="{{ $store ? $store->payment_secret_key : '' }}" type="text"
                                                class="form-control secret" name="payment_secret_key"
