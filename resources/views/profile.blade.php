                    ...
                    <div class="card profile-card flex-column mb-3">
                        ...
                        <div class="card-body d-flex profile-fulldeatil flex-column">
                            ...
                            <div class="profile-info w-100">
                                <h6 class="mb-0 mt-2  fw-bold d-block fs-6 text-center">{{ $admin->first_name }}
                                    {{ $admin->last_name }}</h6>
                                <span
                                    class="py-1 fw-bold small-11 mb-0 mt-1 text-muted text-center mx-auto d-block">{{ $admin->role }}</span>
                            ...
                            <form method="POST" action="{{ url('/profile/edit') }}">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input name="firstname" id="first" value=" {{ $admin->first_name }}"
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input name="lastname" id="first" value=" {{ $admin->last_name }}"
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input name="email" value=" {{ $admin->email }} " id="email" type="email"
                                ...
                                <div class="col-md-12 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input name="role" value=" {{ $admin->role }} " id="role" type="text"
                                            class="form-control" placeholder="Role :" readonly>
                                    </div>
                                </div>
                            ...
                            <form method="POST" action="{{ url('/profile/password') }}">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="password" name="newpassword" class="form-control ps-5"
                                            placeholder="New password" required="">
                                    </div>
                                </div>
                                <div class="col-md-12 col-sm-12">
                                    <div class="form-group">
                                        <label class="form-label">Re-type New password <span
                                                class="text-danger">*</span></label>
                                        <input type="password" name="confirmpassword" class="form-control ps-5"
