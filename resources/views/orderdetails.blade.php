                        ...
                        <div class="card-body">
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    ...
                                    <span><strong>{{ $order->shipping_address }},{{ $order->shipping_city }},
                                            {{ $order->shipping_state }}, {{ $order->shipping_country }}</strong></span>
                                </div>
                                <div class="col-12">
                                ...
                                <div class="col-12">
                                    ...
                                    <span><strong><a href="#"
                                                class="text-muted">{{ $order->status }}</a></strong></span>
                                </div>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($orderDetails as $item)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h6 class="title">{{ $item->name }} <span
                                                                class="d-block fs-6 text-primary">{{ $item->options }}</span>
                                                        </h6>
                                                    </td>
                                                    <td>
                                                        {{ $item->qty }}
