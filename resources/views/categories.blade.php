                    ...
                    <div
                        ...
                        <div class="col-auto d-flex w-sm-100">
                            <button type="button" class="btn btn-primary btn-set-task w-sm-100" data-bs-toggle="modal"
                                data-bs-target="#expadd"><i class="icofont-plus-circle me-2 fs-6"></i>Add Category</button>
                        </div>
                    </div>
                </div>
            </div> <!-- Row end  -->
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group" role="group" aria-label="Basic outlined example">
                                                    <a type="button" class="btn btn-outline-secondary edit-category"
                        ...
                        <div class="deadline-form">
                            ...
                            <div class="row g-3 mb-3">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="number" name="sortorder" placeholder="Sort Order"
                                        class="form-control w-100" id="abc">
                                </div>
                            </div>
                            ...
                            <div class="row g-3 mb-3">
                                <div class="col-sm-12">
                                    ...
                                    <input type="text" class="form-control" id="editcategoryname"
                                        name="editcategoryname" placeholder="Name">
                                </div>
                                <div class="col-sm-6">
                                    <label for="abc" class="form-label">Sort Order</label>
