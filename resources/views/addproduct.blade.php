...
@section('body')
    ...
    <div class="body d-flex py-3">
        <div class="container-xxl">
            <form method="POST" enctype="multipart/form-data" action="{{ secure_url('/product/add') }}">
                                ...
                                <div class="card-body">
                                    <div class="row g-3 align-items-center">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <input required type="number" class="form-control" name="discountedprice"
                                                placeholder="Discounted Price" value="0">
                                        </div>

                                        <div class="col-md-12">
                                            <label class="form-label">Product Cost Price</label>
                                            <input required type="number" class="form-control" name="costprice"
                                                placeholder="Cost Price" value="0">
                                        </div>
                                    ...
                                    <div class="row g-3 align-items-center">
                                        <div class="col-md-12">
                                            ...
                                            <input required type="text" class="form-control" name="sku"
                                                placeholder="SKU e.g SHIRT-WHITE-12">
                                        </div>
                                        <div class="col-md-12">
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <select name="category[]" class="select2" multiple="multiple"
                                        data-placeholder="Choose Product Category(s)" style="width: 100%;" required>
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <select name="related[]" class="select2" multiple="multiple"
                                        data-placeholder="Related Product(s)" style="width: 100%;">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row g-3 align-items-center">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input required type="number" class="form-control" name="sortorder"
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <div class="form-icon position-relative">
                                                                    <input type="number" class="form-control"
                                                                        id="optionquantity" placeholder="Quantity">
                                                                </div>
                                                            </div>
                                                        </div><!--end col-->

                                                        <div class="col-lg-4">
                                                            <button id="addoption" type="button"
                                                                class="btn btn-primary">Add</button><br /><br />
                                                        </div>
