                    ...
                    <div
                        ...
                        <div class="col-auto d-flex w-sm-100">
                            <button type="button" class="btn btn-primary btn-set-task w-sm-100" data-bs-toggle="modal"
                                data-bs-target="#expadd"><i class="icofont-plus-circle me-2 fs-6"></i>Add Options</button>
                        </div>
                    </div>
                </div>
            </div> <!-- Row end  -->
                    ...
                    <div class="modal-body">
                        ...
                        <div class="deadline-form">
                            ...
                            <div class="row g-3 mb-3">
                                <div class="col-sm-12">
                                    <label for="depone" class="form-label">Name</label>
                                    <input type="text" class="form-control" id="editoptionname" name="editoptionname"
                                        placeholder="Name">
                                </div>
                                <div class="col-sm-6">
                                    <label for="abc" class="form-label">Sort Order</label>
                                    <input type="number" class="form-control" id="editoptionsortorder"
                                        name="editoptionsortorder" placeholder="Sort Order">
                                </div>
                            </div>
