                ...
                <ul class="menu-list flex-grow-1 mt-3">
                    ...
                    <li class="collapsed">
                        <a class="m-link" data-bs-toggle="collapse" data-bs-target="#homepage" href="#">
                            <i class="icofont-ui-home fs-5"></i> <span>Home Page</span> <span
                                class="arrow icofont-rounded-down ms-auto text-end fs-5"></span></a>
                        <!-- Menu: Sub menu ul -->
                    ...
                    <li class="collapsed">
                        <a class="m-link" data-bs-toggle="collapse" data-bs-target="#menu-delivery" href="#">
                            <i class="icofont-vehicle-delivery-van fs-5"></i> <span>Delivery Methods</span> <span
                                class="arrow icofont-rounded-down ms-auto text-end fs-5"></span></a>
                        <!-- Menu: Sub menu ul -->
                    ...
                    <li class="collapsed">
                        <a class="m-link" data-bs-toggle="collapse" data-bs-target="#store" href="#">
                            <i class="icofont-settings-alt fs-5"></i> <span>Store</span> <span
                                class="arrow icofont-rounded-down ms-auto text-end fs-5"></span></a>
                        <!-- Menu: Sub menu ul -->
                            ...
                            <div class="dropdown user-profile ml-2 ml-sm-3 d-flex align-items-center zindex-popover">
                                <div class="u-info me-2">
                                    <p class="mb-0 text-end line-height-sm "><span
                                            class="font-weight-bold">{{ Session::get('eszStorename') }}</span></p>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $("#addoption").click(function(e) {
                ...
                if (optionquantity != "") {
                    var tr = "<tr><td id='tdoptionname'>" + optionname + "</td><td id='tdoptionvalue'>" +
                        optionvalue + "</td><td id='tdoptionquanity'>" + optionquantity +
                        "</td><td><a  href='#'><i class='icofont-ui-delete text-danger'></i></a></td/</tr>";
                            ...
                            $.each(response.data, function(key, value) {
                                if (value.optionName == optionName) {
                                    var output = "<option value='" +
                                        optionName + ":" + value
                                        .optionValueName + ":" + value.id +
                                        "'>" + value.optionValueName + " (" +
                                        value.quantity + " in stock)</option>";
            ...
            $("#addproduct").click(function(e) {
                ...
                if (optionquantity != "") {
                    ...
                    var tr = "<tr><td><input type='hidden' id='tdproductid' value='" + productID +
                        "' /></td><td id='mytdproductname'>" + optionname + "</td><td id='myoptions'>" +
                        options + "</td><td id='mytdproductquanity'>" + optionquantity +
                        "</td><td id='tdprice'>" + price + "</td><td id='tdsubtotal'>" + subTotal +
                        "</td><td><a class='deleterowproduct' href='#'><i class='icofont-ui-delete text-danger'></i></a></td/</tr>";
