...
<html lang="en">
  ...
  >
        ...
        <div class="relative -mx-4 flex items-center justify-between">
          <div class="w-60 max-w-full px-4">
            <a
              ...
              :class="scrolledFromTop ? 'py-2' : 'py-5' "
          ...
          <div class="flex w-full items-center justify-between px-4">
            <div>
              ...
              <nav
                ...
                :class="scrolledFromTop ? 'lg:py-3' : 'py-5' "
                id="navbarCollapse"
    ...
    <!-- ====== Hero Section Start -->
    <div
      class="relative z-10 overflow-hidden bg-white pb-[110px] pt-[120px] dark:bg-dark md:pt-[150px] lg:pt-[180px]"
    >
      <div
        class="absolute left-0 top-0 z-[-1] h-full w-full rounded-br-[200px] bg-[#F8F8F8] dark:bg-dark-2 lg:w-1/2"
      ></div>
        ...
        <div class="-mx-4 flex flex-wrap items-center">
          <div class="w-full px-4 lg:w-5/12">
            <div class="hero-content">
              ...
              <p
                class="mb-16 max-w-[440px] text-base text-body-color dark:text-dark-6"
              >
              ...
              <ul class="flex flex-wrap items-center">
                <li>
                  ...
                  >
                    <span
                      class="mr-4 text-dark group-hover:text-primary dark:text-dark-2"
                    >
                      <svg
                        width="45"
                        height="45"
          ...
          <div class="w-full px-4 lg:w-6/12">
            <div class="mx-auto text-center">
              <div class="relative z-10 mt-16 inline-block lg:mt-0">
                <img
                  src="src/assets/images/hero/hero-image-06.svg"
                  alt="hero"
                  class="mx-auto max-w-full"
                />
                <div class="absolute -left-10 -top-10 z-[-1]">
                  <img
                    src="src/assets/images/hero/hero6-shape-1.svg"
                    alt="shape"
                  />
                </div>
        ...
        <div class="-mx-4 flex flex-wrap">
          <div class="h-10 w-full px-4">
            <div class="flex flex-wrap items-center justify-center">
              ...
              >
                <img
                  src="src/assets/images/brands/lineicons.svg"
                  alt="image"
                  class="h-10 max-w-full"
                />
              </a>
              ...
              >
                <img
                  src="src/assets/images/brands/uideck.svg"
                  alt="image"
                  class="h-10 max-w-full"
                />
              </a>
              ...
              >
                <img
                  src="src/assets/images/brands/ayroui.svg"
                  alt="image"
                  class="h-10 max-w-full"
                />
              </a>
        ...
        <div class="-mx-4 mb-10 flex flex-wrap items-center lg:mb-[60px]">
          <div class="w-full px-4 lg:w-6/12">
            <div class="mb-[60px] max-w-[500px] xl:mb-[70px]">
              ...
              <h2
                class="text-3xl font-bold text-dark dark:text-white sm:text-4xl md:text-[40px]"
              >
            ...
            <div class="-mx-4 flex flex-wrap">
              <div class="w-full px-4 sm:w-1/2">
                <div class="mb-10">
                  ...
                  <h3
                    class="mb-3 text-xl font-semibold text-dark dark:text-white 2xl:text-[22px]"
                  >
          ...
          <div class="w-full px-4 lg:w-6/12">
            <div class="flex justify-center">
              <img
                src="src/assets/images/services/services-08/image-01.svg"
                alt="image"
                class="mx-auto max-w-full"
              />
            </div>
    ...
    <section class="bg-white pt-20 dark:bg-dark lg:pt-[120px]">
      <div class="container mx-auto">
        ...
        <div
          class="relative z-10 overflow-hidden rounded-xl bg-white p-11 shadow-pricing-3 dark:bg-dark-2"
        >
          <div class="w-full overflow-x-auto">
            <table class="table-auto">
                ...
                <tr>
                  ...
                  <th class="w-1/4 min-w-[200px] px-5 xl:pt-6">
                    <div class="mb-10 text-left">
                      <span
                        class="mb-[18px] text-lg font-medium text-dark dark:text-white"
                      >
                        Starter
                      </span>
                      <h4
                      ...
                      <p
                        class="mb-6 text-sm font-normal text-body-color dark:text-dark-6"
                      >
              ...
              <tbody>
                <tr>
                  <td
                    class="border-t border-[#EEEEEE] px-5 py-5 dark:border-dark-3"
                  >
                  ...
                  >
                    <h5
                      class="text-center text-base font-medium text-dark dark:text-white"
                    >
                      Features Limits
                    </h5>
                  </td>
                ...
                <tr>
                  ...
                  >
                    <p
                      class="text-center text-base text-body-color dark:text-dark-6"
                    >
                      1 Developer
                    </p>
                  </td>
                ...
                <tr>
                  ...
                  >
                    <p
                      class="flex justify-center text-center text-base text-body-color"
                    >
                      <svg
                        width="25"
                        height="25"
        ...
        <div class="-mx-4 flex flex-wrap justify-center">
          <div class="w-full max-w-[270px] px-4">
            ...
            >
              ...
              <div class="mb-[22px] h-20 w-20 overflow-hidden rounded-[5px]">
                <img
                  src="src/assets/images/team/team-03/image-01.jpg"
                  alt="image"
                  class="w-full"
                />
              </div>
              <div>
                ...
                <p
                  class="mb-8 max-w-[185px] text-xs text-body-color dark:text-dark-6"
                >
                ...
                <div class="flex items-center gap-5">
                  <a
                    href="javascript:void(0)"
                    class="text-dark-8 hover:text-primary"
                  >
                    <svg
                      width="18"
                      height="18"
          ...
          <div class="w-full max-w-[270px] px-4">
            ...
            >
              ...
              <div class="mb-[22px] h-20 w-20 overflow-hidden rounded-[5px]">
                <img
                  src="src/assets/images/team/team-03/image-02.jpg"
                  alt="image"
                  class="w-full"
                />
              </div>
          ...
          <div class="w-full max-w-[270px] px-4">
            ...
            >
              ...
              <div class="mb-[22px] h-20 w-20 overflow-hidden rounded-[5px]">
                <img
                  src="src/assets/images/team/team-03/image-03.jpg"
                  alt="image"
                  class="w-full"
                />
              </div>
    ...
    <section class="dark:bg-dark">
      <div class="container mx-auto">
        <div
          class="relative z-10 overflow-hidden rounded bg-[#c4c4c4] dark:bg-dark-3"
        >
          <div class="-mx-4 flex flex-wrap">
            <div class="w-full px-4 lg:w-1/2">
              <div
                class="px-6 py-14 sm:px-10 md:px-[70px] md:py-20 lg:pl-11 lg:pr-0"
              >
                <h2
            ...
            <div class="w-full self-end px-4 lg:w-1/2">
              <div class="hidden text-center lg:block">
                <img
                  src="src/assets/images/cta/mobile-01.svg"
                  alt="image"
                  class="mx-auto max-w-full"
                />
              </div>
    ...
    <section
      x-data="{activeItem: 1}"
      class="pb-20 pt-20 dark:bg-dark lg:pb-[120px] lg:pt-[120px]"
    >
      <div class="container mx-auto">
        <div class="-mx-4 flex flex-wrap justify-center">
          <div class="w-full px-4">
            ...
            <div x-show="activeItem === 1">
              ...
              >
                ...
                <div class="w-full pl-0 md:pl-14">
                  ...
                  <h6
                    class="text-sm font-normal italic text-body-color dark:text-dark-6"
                  >
                    Founder - Dailousm
                  </h6>
                </div>
          ...
          <div class="w-full pt-12">
            <div class="flex items-center justify-center">
              <button
                ...
                class="mx-4 h-2 w-2 rounded-full hover:bg-secondary"
              ></button>
              <button
                @click="activeItem = 2"
    ...
    <section class="relative z-40 bg-white py-20 dark:bg-dark lg:py-[120px]">
      <div class="container mx-auto">
        <div class="relative bg-white shadow-contact-3 dark:bg-dark-2">
          <div
            class="-mx-4 flex flex-row-reverse flex-wrap items-stretch lg:flex-row"
          >
            <div class="w-full px-4 lg:w-4/12">
              ...
              >
                <div>
                  <div
                    class="-left-8 top-[120px] p-10 lg:absolute lg:-rotate-90 lg:p-0"
                  >
                    <h2
                      class="inline-flex items-center text-xl font-medium uppercase text-white"
                    >
                      <span
                        class="mr-2 inline-block h-[2px] w-6 bg-white"
                      ></span>
                      CONTACT US
                    </h2>
                  </div>
            ...
            <div class="w-full px-4 lg:w-8/12">
              <div class="p-10 md:p-[70px] lg:p-14 xl:p-[70px]">
                <h2
                  class="mb-5 text-[28px] font-bold text-dark dark:text-white"
                >
                  Get In Touch With Us
                </h2>
                <p
                  class="mb-[60px] max-w-[490px] text-base text-body-color dark:text-dark-6"
                >
                  There are many variations of passages of Lorem Ipsum available
                  but the majority have suffered alteration in some form.
                </p>
                    ...
                    <div class="w-full px-4">
                      <div class="mb-10">
                        <textarea
                          ...
                          class="w-full resize-none border-b border-stroke bg-transparent py-4 text-sm text-body-color outline-none placeholder:opacity-50 focus:border-primary focus-visible:shadow-none dark:border-dark-3 dark:text-dark-6"
                        ></textarea>
                      </div>
                    </div>
