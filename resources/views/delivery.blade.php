                    ...
                    <div
                        ...
                        <div class="col-auto d-flex w-sm-100">
                            <button type="button" class="btn btn-primary btn-set-task w-sm-100" data-bs-toggle="modal"
                                data-bs-target="#expadd"><i class="icofont-plus-circle me-2 fs-6"></i>Add</button>
                        </div>
                    </div>
                </div>
            </div> <!-- Row end  -->
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group" role="group" aria-label="Basic outlined example">
                                                    <button type="button" class="btn btn-outline-secondary edit-delivery"
                                            ...
                                            <td class="text-center p-3"><span class="p-2 badge bg-{{ $defaultColor }}">
                                                    {{ $defaultText }}</span></td>
                            ...
                            <div class="row g-3 mb-3">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <input type="text" class="form-control" id="editdescription"
                                        name="editdescription" placeholder="Description" required>
                                </div>
