                    ...
                    <div
                        ...
                        <div class="col-auto d-flex w-sm-100">
                            <button type="button" class="btn btn-primary btn-set-task w-sm-100" data-bs-toggle="modal"
                                data-bs-target="#expadd"><i class="icofont-plus-circle me-2 fs-6"></i>Add Admin</button>
                        </div>
                    </div>
                </div>
            </div> <!-- Row end  -->
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group" role="group" aria-label="Basic outlined example">
                                                    <a type="button" class="btn btn-outline-secondary edit-admin"
                                                        data-bs-toggle="modal" data-bs-target="#expedit"
                                                        data-id="{{ $item->id }}" data-name="{{ $item->first_name }}"
                                                        data-status="{{ $item->status }}" data-role="{{ $item->role }}"
                                                        data-created="{{ $item->created_at }}"><i
                                                            class="icofont-edit text-success"></i></a>
                                                    <a type="button" class="btn btn-outline-secondary delete-admin"
                                                        data-id="{{ $item->id }}"><i
