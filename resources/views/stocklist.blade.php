                        ...
                        <div class="deadline-form">
                            ...
                            <div class="row g-3 mb-3">
                                <div class="col-sm-12">
                                    ...
                                    <input type="text" class="form-control" name="item" id="abc11"
                            ...
                            <div class="row g-3 mb-3">
                                <div class="col-sm-6">
                                    ...
                                    <input type="number" class="form-control" name="total" id="abc11"
                                        placeholder="Total" required>
                                </div>

                                <div class="col-sm-6">
                                    <label for="abc11" class="form-label">Paid</label>
                                    <input type="number" class="form-control" name="paid" id="abc11"
