                                            ...
                                            <div class="product-price">
                                                ...
                                                @php
                                                    if ($product->discounted_price != 0) {
                                                        echo '<p class="sale-price">' .
                                                            Session::get('eszCurrencySymbol') .
                                                            $product->discounted_price .
                                                            '</p>
                                                    <p class="regular-price text-danger">' .
                                                            Session::get('eszCurrencySymbol') .
                                                            $product->price .
                                                            '</p>';
                                                    } else {
                    ...
                    <div class="card">
                        <div class="card-body">
                            <ul class="nav nav-tabs tab-body-header rounded  d-inline-flex" role="tablist">
                                <li class="nav-item"><a class="nav-link active" data-bs-toggle="tab" href="#descriptions"
                                        role="tab">Descriptions</a></li>
                                <li class="nav-item"><a class="nav-link " data-bs-toggle="tab" href="#review"
                                        ...
                                        <div class="col-lg-12 col-md-12">
                                            <form method="POST" action="{{ url('/vendor/product/addreview') }}">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="mb-3">
                                                            <label class="form-label"> Stars <span
                                                                    class="text-danger">*</span></label>
                                                            <select class="form-control" name="stars"
                                                                data-placeholder="Select a stars">
                                                    ...
                                                    <div class="col-md-12 mt-3">
                                                        <div class="mb-3">
                                                            ...
                                                            <div class="form-icon position-relative">
                                                                ...
                                                                <textarea id="message" placeholder="Your Comment" rows="5" name="comment" class="form-control ps-5"
                                                                    required=""></textarea>
                                                            </div>
                                                        </div>
                                                    </div><!--end col-->
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <div class="form-icon position-relative">
                                                                ...
                                                                <input id="email" type="email" placeholder="Email"
                                                                    name="email" class="form-control ps-5"
                                                                    required="">
                                                            </div>
                                                        </div>
                                                    </div><!--end col-->
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="mb-3">
                                        ...
                                        <input value="{{ $product->sku }}" required type="text" class="form-control"
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group mb-3">
                                            <span class="input-group-text border bg-transparent"
                                                id="basic-addon1">$</span>
                                            <input value="{{ $product->discounted_price }}" type="number"
                                                min="0" class="form-control" name="discountedprice"
                                                placeholder="Discounted Price" aria-label="Price"
                                ...
                                <div class="col-6">
                                    <div class="mb-3">
                                        ...
                                        <input value="{{ $product->sort_order }}" required type="number"
                                            class="form-control" name="sortorder" placeholder="Sort Order">
                                    </div>
                                </div><!--end col-->
