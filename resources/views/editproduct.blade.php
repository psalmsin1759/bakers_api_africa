                            ...
                            <div class="card-body">
                                ...
                                <div class="row g-3 align-items-center">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input required type="text" value="{{ $product->name }}" class="form-control"
                                            name="productname" placeholder="Product Name">
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label">Sort Order</label>
                                        <input required type="number" value="{{ $product->sort_order }}"
                                            class="form-control" name="sortorder" placeholder="Sort Order" value="0">
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input required type="number" value="{{ $product->quantity }}" class="form-control"
                                            name="quantity" placeholder="Sort Order" value="0">
                                    </div>

                                    <div class="col-md-6">
                                        <label class="form-label">SKU</label>
                                        <input required type="text" value="{{ $product->sku }}" class="form-control"
                                            name="sku" placeholder="Product Name">
                                    </div>

                                    <div class="col-md-6">
                                        <label class="form-label">Price</label>
                                        <input required type="number" value="{{ $product->price }}" class="form-control"
                                            name="price" placeholder="Sort Order" value="0">
                                    </div>

                                    <div class="col-md-6">
                                        <label class="form-label">Discounted Price</label>
                                        <input required type="number" value="{{ $product->discounted_price }}"
                                            class="form-control" name="discountedprice" placeholder="Discounted Price"
                                            value="0">
                                    </div>

                                    <div class="col-md-12">
                                        <label class="form-label">Cost Price</label>
                                        <input required type="number" value="{{ $product->cost_price }}"
                                            class="form-control" name="costprice" placeholder="Cost Price" value="0">
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="file" name="imageproductimage" id="input-file-to-destroy"
                                            class="dropify" data-allowed-formats="portrait square" data-max-file-size="2M"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <small class="d-block text-muted mb-2">Select Product Image (800x950)</small>
                                        <input type="file" name="imageproductimageone" id="input-file-to-destroy"
                                    ...
                                    <div class="col-md-6">
                                        <label class="form-label">Change Additional Product Images (Optional)</label>
                                        <small class="d-block text-muted mb-2">Select Product Image (800x950)</small>
                                        <input type="file" name="imageproductimagetwo" id="input-file-to-destroy"
                                            class="dropify" data-allowed-formats="portrait square"
                                            data-max-file-size="2M" data-max-height="2000">
                                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group" role="group"
                                                    ...
                                                    <a type="button" class="btn btn-outline-secondary edit-editoption"
                                                        data-bs-toggle="modal" data-bs-target="#expedit"
                                                        data-id="{{ $item->id }}" data-name="{{ $item->option }}"
                                                        data-value="{{ $item->value }}"
                                                        data-quantity="{{ $item->quantity }}"
                                                        data-product="{{ $item->product_id }}"><i
                                                            class="icofont-edit text-success"></i></a>
                                                    <a type="button" class="btn btn-outline-secondary delete-editoption"
                                                        data-id="{{ $item->id }}"><i
                                        ...
                                        <div class="col-lg-12 mt-4 mt-lg-0 pt-2 pt-lg-0">
                                            ...
                                            <form method="POST" action="{{ url('/product/edit/optionadd') }}"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <input name="optionproductid" type="hidden"
                                                        value="{{ $product->id }}">


                                                    <div class="col-6">
                                                        <div class="mb-3">
                                                            <label class="form-label"> Product Option <span
                                                    ...
                                                    <div class="col-6">
                                                        <div class="mb-3">
                                                            <label class="form-label"> Value <span
                                                                    class="text-danger">*</span></label>
                                                            <input type="text" class="form-control" required
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <div class="form-icon position-relative">
                                                                <input type="number" class="form-control"
                                                                    id="myoptionquantity" name="myoptionquantity"
                                                                    required ="Quantity">
                                                            </div>
                                                        </div>
                                                    </div><!--end col-->
                                    ...
                                    @foreach ($relatedProduct as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group" role="group"
                                                    aria-label="Basic outlined example">
                                                    <a type="button" class="btn btn-outline-secondary delete-editrelated"
                                                        data-id="{{ $item->relatedid }}"><i
                                                            class="icofont-ui-delete text-danger"></i></a>
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <div class="col-lg-12 mt-4 mt-lg-0 pt-2 pt-lg-0">
                                            ...
                                            <form method="POST" action="{{ url('/product/editrelatedadd') }}"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="mb-3">
                                                            <label class="form-label"> Choose Product <span
                                                                    class="text-danger">*</span></label>
                                                            <select name="related[]" class="select2" multiple="multiple"
                                                                data-placeholder="Related Product(s)"
                                                                style="width: 100%;">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <button type="submit" class="btn btn-primary">Add Related
                                                            Product</button>
                                                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group" role="group"
                                                    aria-label="Basic outlined example">
                                                    <a type="button"
                                                        class="btn btn-outline-secondary delete-editproductcategory"
                                                        data-id="{{ $item->cpid }}"><i
                                                            class="icofont-ui-delete text-danger"></i></a>
                                                </div>
                                            </td>
                                        ...
                                        <div class="col-lg-12 mt-4 mt-lg-0 pt-2 pt-lg-0">
                                            ...
                                            <form method="POST" action="{{ url('/product/editcategoryadd') }}"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="mb-3">
                                                            ...
                                                            <select name="category[]" class="select2" multiple="multiple"
                                                                data-placeholder=" Category(s)" style="width: 100%;">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <button type="submit" class="btn btn-primary">Add Product To
                                                            Category</button>
                                                    </div>
                        ...
                        <div class="deadline-form">
                            ...
                            <div class="row g-3 mb-3">
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" class="form-control" id="editoptionname" name="optionname"
                                        placeholder="Name" readonly>
                                </div>
                                <div class="col-sm-6">
                                    <label for="abc" class="form-label">Option Value</label>
                                    <input type="text" class="form-control" id="editoptionvalue" name="optionvalue"
                                        placeholder="Sort Order" readonly>
                                </div>
                                <div class="col-sm-12">
