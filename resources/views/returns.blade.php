                    ...
                    <div
                        ...
                        <div class="col-auto d-flex w-sm-100">
                            <button type="button" class="btn btn-primary btn-set-task w-sm-100" data-bs-toggle="modal"
                                data-bs-target="#expadd"><i class="icofont-plus-circle me-2 fs-6"></i>Add Returns</button>
                        </div>
                    </div>
                </div>
            </div> <!-- Row end  -->
                        ...
                        <div class="deadline-form">
                            ...
                            <div class="row g-3 mb-3">
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" class="form-control" name="name" id="abc11"
                                        placeholder="Name" required>
                                </div>

                                <div class="col-sm-6">
                                    <label for="abc11" class="form-label">Customer Phone</label>
                                    <input type="number" class="form-control" name="phone" id="abc11"
                            ...
                            <div class="row g-3 mb-3">
                                <div class="col-sm-6">
                                    ...
                                    <input type="date" name="purchasedate" class="form-control w-100" id="abc"
                                        required>
                                </div>
                                <div class="col-sm-6">
                                    <label for="abc" class="form-label">Return Date</label>
                                    <input type="date" name="returndate" class="form-control w-100" id="abc"
                                        required>
                                </div>
                            </div>
                            ...
                            <div class="row g-3 mb-3">
                                <div class="col-sm-12">
                                    ...
                                    <input type="text" name="amount" class="form-control" id="abc11"
